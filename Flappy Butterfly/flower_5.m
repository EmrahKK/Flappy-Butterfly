...
- (instancetype)initWithGround:(SKNode*)ground atPoint:(CGPoint)point inScene:(SKScene*)scene inNode:(SKNode*)node {
    if (self = [super init]) {
        ...
        CGPathMoveToPoint(path, NULL, 65 - offsetX, 260 - offsetY);
        CGPathAddLineToPoint(path, NULL, 100 - offsetX, 260 - offsetY);
