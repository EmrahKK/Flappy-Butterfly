...
- (instancetype)initWithGround:(SKNode*)ground atPoint:(CGPoint)point inScene:(SKScene*)scene inNode:(SKNode*)node {
    if (self = [super init]) {
        ...
        CGPathMoveToPoint(path, NULL, 70 - offsetX, 280 - offsetY);
        CGPathAddLineToPoint(path, NULL, 100 - offsetX, 280 - offsetY);
        ...
        self.position = CGPointMake(point.x, point.y + self.frame.size.height/2 + 15);
